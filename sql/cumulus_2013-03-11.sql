...
# Database: cumulus
# Generation Time: 2013-03-12 03:59:25 +0000
# ************************************************************
...
CREATE TABLE `sections` (
  ...
  PRIMARY KEY (`sec_id`),
  KEY `index_law` (`law_id`),
  KEY `index_books` (`book_id`),
  KEY `index_titles` (`title_id`),
  KEY `index_ch` (`ch_id`),
  CONSTRAINT `fk_sections_books` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sections_chapters` FOREIGN KEY (`ch_id`) REFERENCES `chapters` (`ch_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sections_Laws` FOREIGN KEY (`law_id`) REFERENCES `laws` (`law_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sections_titles` FOREIGN KEY (`title_id`) REFERENCES `titles` (`title_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
