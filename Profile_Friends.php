...
<form>
    ...
    <div id="container">
        ...
        <div id="advancedSearch_options">        	
            ...
            <div id="tabs">
                <ul>
                    <li><a href="#tab_friends">Friends</a></li>
                                     
                </ul>
                
                <div id="tab_friends"> <!--NOTE that all data is to be pulled from database and should be in rows-->
                	<a href="Profile_Messages.php">Message</a>
