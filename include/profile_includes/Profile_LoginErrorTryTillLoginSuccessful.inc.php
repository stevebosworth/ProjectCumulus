...
$valLoc="location:Profile_LoginErrorTryTillLoginSuccessful.inc.php";
$postLoc="location:../../Profile_Home.php";

//if the page posts back to itself, do the following
if($_POST)
{
	$myValidation=new Validation();
	$myValidation->validateLogin($valLoc,$postLoc);
}
...
<body>
    ...
    <div id="container">
        <header>
            ...
            <!--<span>Username:</span>-->
            <!--<input type="text" name="txt_username" placeholder="Email" autocomplete="on"/>-->
            <!--<span>Password:</span>-->
        ...
        <div id="content_container">
          ...
          <div id="loginErrorRelogin_content">
          <h2>Cumulus Login</h2>
          <h3>ERROR: Your Email or Password is incorrect. To login, please enter your correct email and password.</h3><br/>
            <form method="post" action="Profile_LoginErrorTryTillLoginSuccessful.inc.php">
            <table width="419" height="132" cellspacing="10">
              <tr>
              	<td width="76">Email</td>
                <td width="301"><input type="text" name="txt_email" placeholder="Email" autocomplete="on"/></td>
              </tr>
              <tr>
              	<td>Password</td>
              ...
              <tr>
              	<td></td>
                <td><input type="submit" name="btn_submitLogin" value="Login"/></td>
              </tr>
              <tr>
              	<td></td>
                <td><a href="#">Forgot password?</a>  or  <a href="#">Create new Account</a></td>
              </tr>
            </table>
             
            </form>
            	
          </div><!--/loginErrorRelogin_content-->
